  ...
  const stepsData = [
    {
      ...
      desc: "Submit your basic details through our online application form or visit your nearest branch to get started.",
    },
    {
      step: "02",
      title: "Gold Evaluation",
      desc: "Get your gold evaluated by our certified experts to determine the maximum loan value based on current market rates.",
    },
    {
      step: "03",
      title: "Instant Approval",
      desc: "Once the purity and weight are verified, your loan amount is approved instantly with no long waiting periods.",
    },
    {
      step: "04",
      title: "Documentation",
      desc: "Complete the minimal documentation process with just basic KYC to finalize your gold loan agreement.",
    },
    {
      step: "05",
      title: "Receive Funds",
      desc: "After the final verification, receive the loan funds directly in your bank account for immediate use.",
    },
  ];
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 md:grid-cols-12">
        ...
        <div className="relative flex justify-center self-end items-end md:col-span-5 order-2 md:order-1">
          <div className="relative aspect-square w-full max-w-[320px] md:max-w-[450px] flex items-end md:aspect-4/5">
            <Image
              ...
              alt="Apply Gold Loan Process"
              fill
              priority
              className="z-20 object-contain transition-transform duration-500 hover:scale-105"
              sizes="(max-width: 768px) 100vw, 40vw"
            />
            <div className="absolute inset-0 -z-10 scale-75 rounded-full bg-yellow-100/40 blur-3xl"></div>
          </div>
        </div>
        ...
        <div className="relative z-10 md:col-span-7 order-1 md:order-2">
          <div className="mb-6 md:mb-10 text-center md:text-left">
            ...
            >
              Follow this step-by-step guide to unlock the value of your gold with Money King.
            </Typography>
          </div>
          ...
          <div className="relative flex min-h-160px md:min-h-[200px] items-start gap-4 md:gap-10">
            <div className="relative shrink-0">
              ...
              <div className="absolute inset-0 -z-10 animate-ping rounded-full bg-yellow-100"></div>
            </div>
                ...
                {stepsData.map((_, i) => (
                  <div
                    ...
                    className={`h-1 rounded-full transition-all duration-500 ${
                      i === activeStep ? "w-6 md:w-8 bg-[#D4AF37]" : "w-1.5 md:w-2 bg-gray-200"
                    }`}
                  ></div>
                ))}
              </div>
