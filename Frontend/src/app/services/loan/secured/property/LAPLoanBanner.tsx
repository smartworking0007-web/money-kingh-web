        ...
        <div className="w-full max-w-6xl mx-auto bg-[#FFFFFF] border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.04)] rounded-[25px] md:rounded-[50px] py-6 md:py-16 px-5 md:px-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-20">
            ...
            <div className="max-w-3xl mx-auto mb-6 md:mb-8">
              ...
              >
                The interest rate for a Loan Against Property (LAP) typically
                starts from 9.00% p.a. onwards and depends on factors like your
                CIBIL score (750+), income stability (salaried vs
                self-employed), and the type of property (residential usually
                lower than commercial). It is also influenced by the loan
                amount, tenure, and your existing EMIs, which help lenders
                assess your repayment capacity and determine the final rate
                offered.
              </Typography>
            </div>
