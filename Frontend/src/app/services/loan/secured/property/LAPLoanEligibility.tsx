...
const LAPLoanEligibility = () => {
  const eligibilityData: EligibilityItem[] = [
    ...
    },
    {
      criteria: "Age Limit",
      requirement:
        "21 years (min) up to 60–65 years at the time of loan maturity.",
      icon: History,
    },
    {
      criteria: "Income Requirement",
      requirement:
        "A stable and regular income source is required (varies by lender).",
      icon: Wallet,
    },
    {
      criteria: "CIBIL Score",
      requirement: "A score of 700 – 750+ is preferred for faster approval.",
      icon: Star,
    },
    {
      criteria: "Property Ownership",
      requirement:
        "Ownership of Residential, Commercial, or Industrial property is required.",
      icon: Home,
    },
    {
      criteria: "Employment Stability",
      requirement:
        "Salaried: 1–2 years stability. Self-employed: 2–3 years in business.",
      icon: Briefcase,
    },
    {
      criteria: "Existing Obligations",
      requirement:
        "A low EMI/NMI ratio is preferred for better loan eligibility.",
      icon: TrendingUp,
    },
    {
      criteria: "Loan-to-Value (LTV)",
      requirement:
        "Lenders usually offer 60–75% of the market value of the property.",
      icon: CheckCircle2,
    },
  ];
