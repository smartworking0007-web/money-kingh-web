...
const HomeLoanRatesTable = () => {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-12 -mt-20 md:-mt-20">
      <Typography variant="h3" className="text-center font-bold mb-6 md:mb-10 text-[#0b1c44] text-xl md:text-3xl">
        ...
        <table className="w-full text-left border-collapse bg-white min-w-[800px]">
          <thead>
            <tr className="bg-[#1a5fb4] text-white">
              <th className="p-3 md:p-4 font-bold border-r border-blue-400 whitespace-nowrap">Bank Name</th>
              <th className="p-3 md:p-4 font-bold border-r border-blue-400 whitespace-nowrap">Interest Rate</th>
              <th className="p-3 md:p-4 font-bold border-r border-blue-400">Processing Fee</th>
      ...
      {/* Mobile Hint */}
      <p className="block md:hidden mt-2 text-[10px] text-gray-500 text-center">
