...
export default function HomeLoanBTJourney() {
  ...
  const steps = [
    {
      ...
      content:
        "Share your details and submit the BT request through our secure portal.",
    },
    {
      title: "Step 2: Submit Documents",
      content:
        "Submit the required KYC, property, income and loan documents from your current lender. This includes verifications like income assessment, legal, technical, and a personal discussion to be conducted by our experts.",
    },
    {
      title: "Step 3: Loan Disbursal & Approval",
      content:
        "Once verified, the agreement is signed and your loan balance is successfully transferred to Money King Home Loans.",
    },
  ];
