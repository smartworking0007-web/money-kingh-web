        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <Typography className="text-blue-50 text-sm md:text-base leading-relaxed max-w-lg mt-0 opacity-90">
              At Money King, we combine trust, transparency, and tailored financial solutions to empower your growth. 
              With quick approvals, customer-first service, and competitive rates – we’re here to make finance simpler for you.
            </Typography>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {stats.map((item, idx) => (
              ...
              >
                ...
                >
                  <span className="text-green-600">{item.title.split(' ')[0]}</span> {item.title.split(' ').slice(1).join(' ')}
                </Typography>
