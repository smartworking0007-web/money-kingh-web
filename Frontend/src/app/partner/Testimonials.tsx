...
interface ChannelPartnerTestimonial {
  name: string;
  role: string;
  text: string;
  image: string;
...
const testimonials: ChannelPartnerTestimonial[] = [
  {
    name: "Rajesh Sharma",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          >
            ...
            <span className="text-blue-600">Testimonials Hub</span>
          </Typography>
          <Typography className="text-gray-500 text-sm md:text-base max-w-2xl mx-auto mt-0 leading-relaxed">
            Witness the synergy of success in our channel partner testimonials,
            highlighting the strength and reliability of Money King.
          </Typography>
        </div>
        ...
        <div className="relative">
          ...
          <div className="hidden md:flex absolute -left-6 top-1/2 -translate-y-1/2 z-10">
            <button
              ...
              className="p-3 bg-white rounded-full shadow-lg hover:bg-blue-600 hover:text-white transition-all"
            >
            ...
            {testimonials.slice(0, 2).map((item, idx) => (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start relative z-10">
                  ...
                  <div className="w-32 h-40 md:w-48 md:h-60 shrink-0 rounded-2xl overflow-hidden shadow-lg bg-slate-100">
                    <Image
                      src={item.image}
                      alt={item.name}
                      width={item.width}
                  ...
                  <div className="flex-1 space-y-4">
                    <div>
                      <Typography
                        variant="h5"
                        className="font-bold text-blue-600 text-lg md:text-xl mt-0"
                      >
                        {item.name}
                      </Typography>
