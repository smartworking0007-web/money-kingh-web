    ...
    <div className="bg-white selection:bg-blue-100 font-sans text-left text-black">
          ...
          <div className="lg:w-3/5">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/20 border border-blue-400/30 mb-6">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-blue-200">
                Pre-Owned Vehicle Finance Experts
              </span>
            </div>
            <Typography
              variant="h1"
            ...
            >
              Drive Your Dream Car <br /> With <span className="text-blue-400">Money King</span>
            </Typography>
            <Typography
              variant="s1"
              className="text-blue-100/80 mb-10 max-w-xl text-lg lg:text-xl"
            >
              Get high-value financing for certified pre-owned cars. Quick transfer, 
              flexible tenures, and the trust of Money King Financial Services.
            </Typography>
            ...
            <div className="flex flex-wrap gap-5 items-center text-left">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-xl font-bold transition-all transform hover:scale-105 shadow-xl shadow-blue-600/30">
               <a href="/contact">FINANCE YOUR CAR</a>
              </button>
      ...
      <div className="max-w-[1300px] mx-auto px-6 -mt-10 relative z-20">
        <div className="bg-white rounded-2xl shadow-xl grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100 border border-gray-50">
          <StatItem label="Funding" value="Up to 90%*" />
          <StatItem label="Loan Tenure" value="Up to 5 Yrs" />
          <StatItem label="Valuation" value="Instant" />
          <StatItem label="Ownership" value="Easy Transfer" />
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            ...
            <Typography variant="b1" className="text-gray-600 mb-8 leading-relaxed">
              Why wait for a new car when you can drive a premium pre-owned vehicle now? 
              Money King Financial Services offers seamless used car loans with 
              minimum documentation and doorstep evaluation.
            </Typography>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <BenefitItem icon={<Car className="text-blue-600" />} text="Wide Vehicle Choice" />
              <BenefitItem icon={<TrendingUp className="text-blue-600" />} text="Lowest ROI in Segment" />
              <BenefitItem icon={<ShieldCheck className="text-blue-600" />} text="Transparent RC Transfer" />
              <BenefitItem icon={<Zap className="text-blue-600" />} text="Quick Disbursement" />
            </div>
          </div>
          <div className="lg:w-1/2 grid grid-cols-2 gap-4">
            <div className="space-y-4 mt-8">
              <FeatureCard icon={<Gauge />} title="Fast Valuation" color="bg-blue-50" />
              <FeatureCard icon={<Clock />} title="Zero Delay" color="bg-green-50" />
            </div>
            <div className="space-y-4">
              <FeatureCard icon={<ShieldCheck />} title="Verified Sellers" color="bg-yellow-50" />
              <FeatureCard icon={<Zap />} title="Minimal Paperwork" color="bg-purple-50" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1300px] mx-auto grid lg:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-black">
            ...
            <div className="space-y-6">
              <RequirementRow label="Min. Salary" value="₹20,000 / Month" />
              <RequirementRow label="Applicant Age" value="21 - 60 Years" />
              <RequirementRow label="Car Age" value="Max. 10 Yrs (at maturity)" />
          ...
          <div className="bg-[#001f3f] p-8 rounded-3xl text-white shadow-xl relative overflow-hidden">
            ...
            <ul className="space-y-4">
              {["Car RC & Insurance Copy", "Last 6 Months Bank Statement", "PAN & Aadhar Card", "Last 3 Months Salary Slip", "Address Proof of Applicant"].map((item, i) => (
...
export default UsedCarLoanView;