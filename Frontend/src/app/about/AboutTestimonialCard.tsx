...
// 1. Sabhi unique reviews row 1 ke liye (Repeat issue fix)
const row1: Testimonial[] = [
  {
    name: "Vikram Singh",
    role: "Startup Founder, Mumbai",
    quote: "Cash flow was tight. Money King provided working capital loans with quick processing.",
    image: "/images/Testimonial/3.jpeg",
  },
  {
    name: "Amit Patel",
    role: "Shop Owner, North Delhi",
    quote: "Took a loan for renovation. Valuation quick, and funds came in record time. Professional team.",
    image: "/images/Testimonial/5.jpeg",
  },
  {
    name: "Neha Gupta",
    role: "Homemaker",
    quote: "First time taking a loan. Money King made it so simple with polite staff guidance.",
    image: "/images/Testimonial/6.jpeg",
  },
  {
    name: "Ananya Roy",
    role: "Freelance Designer, Pune",
    quote: "Instant approval without physical visits. Best customer experience for quick loans.",
    image: "/images/Testimonial/5.jpeg",
  },
  {
    name: "Manish Verma",
    role: "Trader, Ahmedabad",
    quote: "Smooth balance transfer and got an instant top-up without hidden charges.",
    image: "/images/Testimonial/7.jpeg",
  },
];

// 2. Sabhi unique reviews row 2 ke liye
const row2: Testimonial[] = [
  {
    name: "Sandeep Kumar",
    role: "SME Owner, Rohini",
    quote: "Best decision for my business expansion loan. Quick documentation and fast disbursal.",
    image: "/images/Testimonial/7.jpeg",
  },
  {
    name: "Rajesh",
    role: "Self-Employed, Noida",
    quote: "Urgent medical expense — got instant personal loan approval. Very cooperative team.",
    image: "/images/Testimonial/8.jpeg",
  },
  {
    name: "Pooja Sharma",
    role: "IT Professional, Bengaluru",
    quote: "Smooth digital verification and very reasonable interest rates. Highly satisfied.",
    image: "/images/Testimonial/6.jpeg",
  },
  {
    name: "Gaurav Mehta",
    role: "Consultant, Gurgaon",
    quote: "Minimal documentation and the loan amount was credited within 24 hours.",
    image: "/images/Testimonial/3.jpeg",
  },
  {
    name: "Kavita Nair",
    role: "Teacher, Chennai",
    quote: "Very transparent process with no hidden processing fees. Highly recommended!",
    image: "/images/Testimonial/5.jpeg",
  },
];
...
const TestimonialItem = ({ item }: { item: Testimonial }) => (
  <div className="shrink-0 w-[280px] md:w-[380px] bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-sm flex flex-col h-full mx-3 md:mx-4 transition-all hover:shadow-md hover:border-blue-100">
    <div className="mb-4">
      ...
      >
        <path
          d="M0 28V13.1026C0 9.15385 1.09687 5.80342 3.2906 3.05128C5.48433 0.299145 8.4359 -0.65812 12.1453 0.179487V6.16239C9.81197 6.16239 8.34615 6.94017 7.74786 8.49573C7.26923 9.69231 7.02991 11.0085 7.02991 12.4444H12.1453V28H0ZM21.5385 28V13.1026C21.5385 9.15385 22.6353 5.80342 24.8291 3.05128C27.0228 0.299145 29.9744 -0.65812 33.6838 0.179487V6.16239C31.3504 6.16239 29.8846 6.94017 29.2863 8.49573C28.8077 9.69231 28.5684 11.0085 28.5684 12.4444H33.6838V28H21.5385Z"
          fill="#2563EB"
        />
      </svg>
    </div>
    ...
    <div className="flex items-center gap-3 border-t border-slate-50 pt-5 mt-auto">
      ...
      <div className="flex flex-col min-w-0">
        <h4 className="font-bold text-slate-900 text-xs md:text-sm tracking-tight truncate">
          {item.name}
        </h4>
  ...
  return (
    <section className="py-12 md:py-20 bg-[#F8FAFC] overflow-hidden font-lexend">
      ...
      <div className="flex flex-col gap-4 md:gap-8">
        {/* Seamless marquee ke liye sirf 2 sets use kiye hain */}
