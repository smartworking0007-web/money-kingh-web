...
export const heroSlides: HeroSlide[] = [
  ...
  title: "Your Wealth.\nOur Strategy.\nYour Future.",
  description: "Bes poke financial strategies designed for discerning individuals, families, and businesses who demand clarity, precision, and measurable results.",
